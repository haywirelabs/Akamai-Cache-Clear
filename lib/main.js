...
*/
  ...
  console.log(configProjectsAvailable)

  if(configProjectsAvailable.indexOf(projectName) >= 0){

    //TODO: Need to pass the below 'learn' value as the value of string 'projectName'
    var name = cpConfig.learn;
    cpcodekeys = Object.keys(name);
    cpcodekeys.forEach(function(cpcodekeys){
      var cpCode = name[cpcodekeys];
